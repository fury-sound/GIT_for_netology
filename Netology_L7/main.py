# Для проверки заданий 1 и 2 раскомментируйте строку 118 main() и запустите файл на исполнение :-)
# Task 1
...
# Task 3
# Для вызова функции чтения и записи отсортированного содержимого файлов раскомментируйте строку 165, file_sorter_main()
